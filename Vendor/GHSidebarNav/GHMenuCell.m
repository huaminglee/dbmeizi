...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
	if ((self = [super initWithStyle:style reuseIdentifier:reuseIdentifier])) {
        ...
        self.backgroundColor = [UIColor colorWithRed:(237.0f/255.0f) green:(244.0f/255.0f) blue:(237.0f/255.0f) alpha:1.0f];
//        self.backgroundColor = [UIColor clearColor];
		UIView *bgView = [[UIView alloc] init];
		bgView.backgroundColor = [UIColor colorWithRed:(51.0f/255.0f) green:(119.0f/255.0f) blue:(170.0f/255.0f) alpha:1.0f];
//        bgView.backgroundColor = [UIColor colorWithRed:(131.0f/255.0f) green:(191.0f/255.0f) blue:(115.0f/255.0f) alpha:1.0f];
...
//        self.textLabel.textColor = [UIColor colorWithRed:(3.0f/255.0f) green:(123.0f/255.0f) blue:(130.0f/255.0f) alpha:1.0f];
...
//		bottomLine.backgroundColor = [UIColor colorWithRed:(40.0f/255.0f) green:(47.0f/255.0f) blue:(61.0f/255.0f) alpha:1.0f];
		bottomLine.backgroundColor = [UIColor colorWithRed:(180.0f/255.0f) green:(180.0f/255.0f) blue:(180.0f/255.0f) alpha:1.0f];
